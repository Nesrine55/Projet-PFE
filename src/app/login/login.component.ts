...
export class LoginComponent {
  ...
  public ngOnInit(){
    ...
    $(document).ready(function () {
      ...
      // form switch
      $('a.switch').click(function (this:any, e:any) {
      ...
      // Form submit
      $('form.signup-form').submit(function (event:any) {
          event.preventDefault();
  
          if (usernameError == true || emailError == true || passwordError == true || passConfirm == true) {
              $('.name, .email, .pass, .passConfirm').blur();
          } else {
              $('.signup, .signupC').addClass('switched');
  
              setTimeout(function () { $('.signup, .signupC').hide(); }, 700);
